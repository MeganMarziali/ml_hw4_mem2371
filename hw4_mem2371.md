...
After removing the variables “habits7” (% missing) and “povertygroup” (%
missing), and deleting missing observations, the total N for the dataset
is 3552.
...
```
    ...
    ## List of 9
    ##  $ cluster     : Named int [1:50] 2 2 2 3 2 3 1 2 2 3 ...
    ##   ..- attr(*, "names")= chr [1:50] "Alabama" "Alaska" "Arizona" "Arkansas" ...
    ##  $ centers     : num [1:3, 1:4] 4.27 11.81 8.21 87.55 272.56 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##   .. ..$ : chr [1:3] "1" "2" "3"
    ##   .. ..$ : chr [1:4] "Murder" "Assault" "UrbanPop" "Rape"
    ##  $ totss       : num 355808
    ##  $ withinss    : num [1:3] 19264 19564 9137
    ##  $ tot.withinss: num 47964
    ##  $ betweenss   : num 307844
    ##  $ size        : int [1:3] 20 16 14
    ##  $ iter        : int 2
    ##  $ ifault      : int 0
    ##  - attr(*, "class")= chr "kmeans"
