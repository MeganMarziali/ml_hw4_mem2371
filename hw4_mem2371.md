...
set.seed(100)
gap_stat = clusGap(us_arrest, FUN = kmeans, nstart = 25, K.max = 10, B = 50)
print(gap_stat, method = "firstmax")
```

    ## Clustering Gap statistic ["clusGap"] from call:
    ## clusGap(x = us_arrest, FUNcluster = kmeans, K.max = 10, B = 50,     nstart = 25)
    ## B=50 simulated reference sets, k = 1..10; spaceH0="scaledPCA"
    ##  --> Number of clusters (method 'firstmax'): 10
    ##           logW   E.logW        gap     SE.sim
    ##  [1,] 7.122749 7.147576 0.02482702 0.06032476
    ##  [2,] 6.495386 6.542217 0.04683053 0.05623520
    ##  [3,] 6.155250 6.229653 0.07440325 0.03693144
    ##  [4,] 5.956150 6.043095 0.08694583 0.04262163
    ##  [5,] 5.814503 5.908113 0.09361040 0.04432048
    ##  [6,] 5.676846 5.810660 0.13381414 0.04593458
    ##  [7,] 5.576893 5.723784 0.14689158 0.04952076
    ##  [8,] 5.486296 5.645472 0.15917633 0.05007532
    ##  [9,] 5.395622 5.571159 0.17553645 0.05072387
    ## [10,] 5.324589 5.500528 0.17593865 0.05278010

``` r
#How do we know what our max k should be?

clusters.10 = kmeans(us_arrest, 10, nstart = 25)

str(clusters.10)
```

    ## List of 9
    ##  $ cluster     : Named int [1:50] 8 1 4 5 4 5 9 8 2 5 ...
    ##   ..- attr(*, "names")= chr [1:50] "Alabama" "Alaska" "Arizona" "Arkansas" ...
    ##  $ centers     : num [1:10, 1:4] 13.5 14.2 5.75 9.95 11.5 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##   .. ..$ : chr [1:10] "1" "2" "3" "4" ...
    ##   .. ..$ : chr [1:4] "Murder" "Assault" "UrbanPop" "Rape"
    ##  $ totss       : num 355808
    ##  $ withinss    : num [1:10] 676 742 1793 783 1695 ...
    ##  $ tot.withinss: num 10021
    ##  $ betweenss   : num 345787
    ##  $ size        : int [1:10] 3 2 8 4 6 3 4 7 10 3
    ##  $ iter        : int 3
    ##  $ ifault      : int 0
    ##  - attr(*, "class")= chr "kmeans"

``` r
fviz_cluster(clusters.10, data = us_arrest)
```
