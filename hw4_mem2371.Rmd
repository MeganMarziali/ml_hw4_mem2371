...
# Just scale anyways, more of a concern when you have really different things that you want to put into the model
...
#Informed by background knowledge, how many clusters might make sense, can do based on trial and error
